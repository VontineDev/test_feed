...
실제 모의투자 1기 라이브 결과(2026-05-17~08-17, 130건)는 전체 승률 **9.5%**,
평균수익 **-4.86%**로 정반대였다(모델별로도 ichimoku만 플러스, 나머지 전부
마이너스). 백테스트 승률·수익률을 실전 기대치로 그대로 믿지 말 것 — 이 괴리
자체가 별도로 조사가 필요한 미해결 이슈다.
