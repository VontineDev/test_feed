...
class TestSparkline:
    ...
    def test_sparkline_returns_svg_with_sufficient_history(self):
        ...
        from reports.generate_html_report import _sparkline
...
class TestCloseHistoryPopulation:
    ...
    def test_close_history_populated_from_screen_ticker(self):
        ...
        from unittest.mock import patch
        from analysis.chart_screener import screen_ticker, calc_ichimoku
        ...
        with patch("analysis.chart_screener.fetch_weekly_ohlcv", return_value=df):
...
class TestSectorGroupedView:
    ...
    def test_empty_sector_goes_to_gita_bucket(self):
        ...
        from reports.generate_html_report import _group_by_sector
        r = _make_result(sector="")
